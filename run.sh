...
python3 topo_opt.py --domain building --problem buckling --objf compliance --confs volume_ub frequency stress displacement --nx 100 --r0 1.0 --vol-frac-ub 0.25 --omega-lb 20 --maxit 500 --stress-ub 5.0e+6  --dis-ub 0.1 --note ks_rho=160 --kokkos --check-gradient
