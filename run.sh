...
# python3 topo_opt.py --domain beam --objf compliance-buckling --confs volume_ub --nx 360 --r0 6.0 --vol-frac-ub 0.45 --weight 0.08 --delta-p 0.01 --delta-beta 0.2 --maxit 1000 --note atype=0
